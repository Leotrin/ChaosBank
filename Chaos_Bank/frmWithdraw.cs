        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    String update1 = "Insert into tblSherbimi (IDKlient, Sherbimi, Data, Vlera, IDBank) values(" + Int32.Parse(this.txtID.Text) + " , 'Withdraw' , @data , " + Int32.Parse(this.txtAmount.Text) + ", " + Int32.Parse(this.cmbBankNr.Text) + ")";
                ...
                {
                    MessageBox.Show("Withdraw registered sucssefuly!", "Information");
                    con.Close();
